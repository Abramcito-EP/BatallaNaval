...
.preview-image.classic {
  background-image: url('/images/scenarios/classic.jpg'), linear-gradient(to bottom, #0f1e3a, #0a1526);
}

.preview-image.foggy {
  background-image: url('/images/scenarios/foggy.jpg'), linear-gradient(to bottom, #1a2639, #0e1320);
}

.preview-image.stormy {
  background-image: url('/images/scenarios/stormy.jpg'), linear-gradient(to bottom, #1a1e2c, #0d0f16);
}

.scenario-info {
  @apply p-4 bg-black/60 backdrop-blur-sm;
}

.scenario-name {
  @apply text-lg font-bold text-yellow-400 mb-2;
}
...
.stat-label {
  @apply text-xs text-blue-300 w-20;
}

.stat-bar-container {
  @apply flex-1 h-1.5 rounded bg-black/50;
}
...
@keyframes pulse {
  0% { box-shadow: 0 0 0 0 rgba(42, 133, 255, 0.7); }
  70% { box-shadow: 0 0 0 10px rgba(42, 133, 255, 0); }
  100% { box-shadow: 0 0 0 0 rgba(42, 133, 255, 0); }
}
