<template>
    <div class="game-background min-h-screen text-gray-100 relative overflow-hidden flex justify-center items-center">
        ...
        <div class="relative z-10 w-full max-w-md px-6 py-8">
            <Head title="Iniciar Sesión - Batalla Naval" />
            ...
            <div class="game-panel">
                <div class="panel-header">
                    <h2 class="text-xl font-bold text-center">ACCESO A LA FLOTA</h2>
                </div>
                
                <div class="panel-content">
                    <!-- Mensaje de estado -->
                    <div v-if="status" class="game-alert success mb-4">
                        {{ status }}
                    </div>
                ...
                <div class="panel-footer flex justify-center md:justify-between items-center">
                    <a
                        href="/"
...
/* Panel principal de login con estilo de juego */
.game-panel {
